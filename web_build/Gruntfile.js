module.exports = function (grunt) {
    ...
    grunt.registerTask('build_dev',function(){
        var html=grunt.file.read("../web/src/main/webapp/base.html",null);
        grunt.file.recurse('../web/src/main/webapp/module/.', function(abspath, rootdir, subdir, filename){
            if(filename.indexOf("Ctrl")>=0){
                html+="<script type='text/javascript' src='module/"+subdir+"/"+filename+"'></script>";
            }
        });
        html+="</body></html>";
        grunt.file.write('../web/src/main/webapp/index.html', html,null);
    });
